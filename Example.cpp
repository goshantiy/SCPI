...
// The server socket 5025 on the VNA software must be on(System > Misc Setup > Network Setup >
// Socket Server = ON). The library visa32.dll must be installed on the system.

// Make sure the VNA software displays "Ready" in the lower right - hand corner of the VNA
// application window.
...
int main(int argc, char *argv[])
{
    ...
    // Calculate loss
    double Loss =
     -20 * std::log(std::sqrt(Data[i * 2] * Data[i * 2] + Data[i * 2 + 1] * Data[i * 2 + 1]));
    //
